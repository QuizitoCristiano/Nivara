          ...
          >
            {offers.map((offer) => (
              <div key={offer.id} className="w-full flex-shrink-0">
                <div className="bg-gradient-to-r from-primary/20 via-primary/15 to-primary/10 p-6 md:p-8 rounded-lg shadow-sm border border-primary/30 relative overflow-hidden">
                  {/* Background Pattern */}
                  ...
                  <div className="relative flex flex-col md:flex-row items-center gap-6 md:gap-8">
                    ...
                    <div className="flex-1 text-center md:text-left">
                      {/* Badge */}
                      <div className="inline-flex items-center px-3 py-2 bg-secondary text-secondary-foreground text-xs font-medium rounded-sm mb-4">
                        {offer.badge}
                      </div>
                    ...
                    <div className="flex-1 flex flex-col items-center gap-4">
                      ...
                      <div className="relative">
                       ...
                       {/* Button */}
                       <Button 
                        className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-3 rounded-sm font-medium shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 border-0"
                      >
                        {offer.buttonText}
                      </Button>
