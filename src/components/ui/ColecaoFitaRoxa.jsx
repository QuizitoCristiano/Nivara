    ...
    return (
      <section className="w-full min-h-screen flex flex-col items-center justify-center bg-white dark:bg-zinc-900 px-6 py-12">
        ...
        <div className="relative mb-6">
          ...
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-32 h-4 bg-purple-500 rounded-full opacity-60 blur-sm"></div>
        </div>
        ...
        <div className="flex gap-4 mt-4 overflow-x-auto scrollbar-hide">
          {[...Array(5)].map((_, i) => (
            <img
              ...
              src={FlorRoxa}
              alt={`Miniatura ${i + 1}`}
              className="w-16 h-16 object-contain border-2 border-transparent hover:border-purple-500 rounded-md transition-all"
            />
          ))}
        </div>
      </section>
